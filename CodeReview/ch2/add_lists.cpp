...
//iterative approach to add two given lists
Node * add_iterative(Node * list1, Node * list2){
	...
	while( list1 || list2 ){
		...
		//if this is the first node, populated the result, else add to the tail
		if(list3 == nullptr){
			list3 = temp;
		}else{
			list3Tail->next = temp;
...
//helper routine for padding the shorter list
